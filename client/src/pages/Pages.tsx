...
const Pages: React.FC = () => {
  ...
  const sortPages = (order: "asc" | "desc", pagesToSort: typeof filteredPages) => {
  ...
  return (
    <div className="">
      <div className="flex justify-between mb-4">
        <select className="border rounded-lg px-4 py-1" value={sortOrder} onChange={(e) => handleSortChange(e.target.value as "asc" | "desc")}>
