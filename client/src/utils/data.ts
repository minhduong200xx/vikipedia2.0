    ...
    paragraph: [
      {
        ...
        segment: [
          {
            content:
            `第二次世界大戦 (WWII または WW2) または第二次世界大戦は、1939 年から 1945 年まで続いた世界規模の紛争です。すべての大国を含む世界の大多数の国は、連合国と同盟という 2 つの対立する軍事同盟の一部として戦いました。 軸。 多くの参加者は経済的、産業的、科学的能力をこの総力戦の背後に投げ込み、民間資源と軍事資源の区別があいまいになりました。 航空機は主要な役割を果たし、人口密集地への戦略爆撃と、戦争で使用された唯一の 2 つの核兵器の運搬を可能にしました。 これは史上最も死者数の多い紛争であり、7,000万人から8,500万人が死亡し、そのほとんどが民間人であった。 ホロコーストを含む大量虐殺、飢餓、虐殺、病気によって何百万人もの人々が亡くなりました。 枢軸国の敗北を受けて、ドイツ、オーストリア、日本が占領され、ドイツと日本の指導者に対する戦争犯罪法廷が行われた。`,
          },
          {
            content:
              `戦争の原因については議論がある。 要因としては、ヨーロッパにおけるファシズムの台頭、スペイン内戦、日中戦争、日ソ国境紛争、第一次世界大戦後の緊張などが挙げられる。第二次世界大戦は一般に9月1日に始まったと考えられている。 1939年、アドルフ・ヒトラー率いるナチス・ドイツがポーランドに侵攻した。 イギリスとフランスは9月3日にドイツに宣戦布告した。 1939年8月のモロトフ・リッベントロップ協定に基づき、ドイツとソ連はポーランドを分割し、フィンランド、エストニア、ラトビア、リトアニア、ルーマニアにまたがる「勢力圏」を定めた。 1939 年末から 1941 年初頭にかけて、一連の戦役と条約により、ドイツはイタリア、日本、その他の国々と枢軸と呼ばれる軍事同盟を結び、ヨーロッパ大陸の大部分を征服または支配しました。 北アフリカと東アフリカでの作戦の開始、および 1940 年半ばのフランスの崩壊に続いて、戦争は主にヨーロッパの枢軸国と大英帝国の間で続き、バルカン半島での戦争、ブリテン空軍戦、電撃戦が行われました。 英国の戦い、そして大西洋の戦い。 1941 年 6 月、ドイツはヨーロッパの枢軸国を率いてソ連に侵攻し、史上最大の陸上戦域である東部戦線を開きました。`,
          },
          {
            content:
              `アジアと太平洋の支配を目指していた日本は、1937年までに中華民国と戦争状態にあった。1941年12月、日本は真珠への攻撃を含む、東南アジアと中央太平洋に対するほぼ同時に攻撃を行い、アメリカとイギリスの領土を攻撃した。 港湾の結果、米国と英国が日本に対して宣戦布告した。 欧州枢軸国は団結して米国に宣戦布告した。 日本はすぐに西太平洋の大部分を征服しましたが、決定的なミッドウェー海戦に敗れた後、1942 年にその進撃は止まりました。 ドイツとイタリアは北アフリカとソ連のスターリングラードで敗北した。 1943 年の主要な挫折（東部戦線でのドイツの敗北、シチリア島とイタリア本土への連合軍の侵攻、太平洋での連合軍の攻勢など）により、枢軸国は主導権を失い、あらゆる戦線で戦略的後退を余儀なくされました。 1944年、西側連合国がドイツ占領下のフランスに侵攻する一方、ソ連は失った領土を取り戻し、ドイツとその同盟国を押し返した。 1944年から1945年にかけて、連合国が日本海軍を無力にし、西太平洋の主要な島々を占領する一方で、日本はアジア本土で逆転に苦しんだ。 ヨーロッパにおける戦争は、ドイツ占領地の解放と西側連合国とソ連によるドイツ侵攻で終結し、ソ連軍によるベルリン陥落、ヒトラーの自殺、そして1945年5月8日のドイツの無条件降伏で最高潮に達した。 ポツダム宣言の条件に基づく降伏を日本が拒否したことを受けて、米国は8月6日に広島に、8月9日に長崎に最初の原子爆弾を投下した。 日本列島への差し迫った侵略、更なる原爆投下の可能性、そして満州侵攻前夜にソ連の対日参戦宣言に直面して、日本は8月10日に降伏の意向を発表し、2日に降伏文書に署名した。 1945年9月。`,
          },
          {
            content:
              `第二次世界大戦は世界の政治的連携と社会構造を変化させ、20 世紀の残りから現在に至るまでの国際秩序の基礎を築きました。 国連は国際協力を促進し紛争を防止するために設立され、戦勝国である中国、フランス、ソ連、英国、米国が安全保障理事会の常任理事国となっています。 ソ連と米国は対立する超大国として台頭し、半世紀近く続く冷戦の舞台となった。 ヨーロッパの荒廃をきっかけに、大国の影響力は弱まり、アフリカとアジアの植民地化解除が始まりました。 産業が被害を受けたほとんどの国は、経済の回復と拡大に向けて動きました。`,
          },
        ],
      },
      {
        ...
        segment: [
          {
            content:
              `ヨーロッパでは一般に、第二次世界大戦は1939年9月1日に始まり[1][2]、ドイツのポーランドとイギリスへの侵攻と、2日後の1939年9月3日にフランスがドイツに宣戦布告したことから始まったと考えられている。 太平洋戦争の開始日には、1937 年 7 月 7 日の日中戦争の開始 [3] [4] や、それ以前の 1931 年 9 月 19 日の日本の満州侵攻が含まれます [5] [6]。 英国の歴史家A.J.P.テイラーに従う人もいる。彼は、日中戦争とヨーロッパとその植民地での戦争は同時に起こり、2つの戦争は1941年に第二次世界大戦になったと主張した[7]。 第二次世界大戦に時々使用される他の開始日には、1935 年 10 月 3 日のイタリアのアビシニア侵攻が含まれます。 英国の歴史家アントニー・ビーバーは、1939年5月から9月にかけて日本とモンゴル軍およびソ連軍との間で戦われたハルヒン・ゴルの戦いが第二次世界大戦の始まりであると見ている[9]。 スペイン内戦を第二次世界大戦の始まりまたは前兆と見る人もいます。`,
          },
          {
            content:
            `戦争が終わった正確な日付も、普遍的に合意されているわけではありません。 当時、戦争は 1945 年 9 月 2 日の日本の正式な降伏によってアジアでの戦争が正式に終了したのではなく、1945 年 8 月 15 日 (V-J デー) の休戦によって終わったと一般的に受け入れられていました。 1951年に日本と連合国との間で平和条約が締結された[12]。 ドイツの将来に関する1990年の条約により、東西ドイツの統一が実現し、第二次世界大戦後のほとんどの問題が解決された[13]。 日本とソ連の間で正式な平和条約は締結されなかったが[14]、両国間の戦争状態は1956年の日ソ共同宣言によって終結し、両国間の完全な外交関係も回復した。`,
          },
        ],
      },
      {
      ...
      },
      {
        ...
        segment: [
          {
            content:
            `連合国はオーストリアとドイツに占領政権を設立したが、どちらも当初はそれぞれ西側連合国とソ連が管理する西占領地域と東占領地域に分割されていた。 しかし、彼らの道はすぐに分かれました。 ドイツでは、西側連合国とソ連が管理する西側と東側の占領地域は1949年に正式に終了し、それぞれの占領地域は西ドイツと東ドイツという別の国となった[313]。 しかし、オーストリアでは占領が 1955 年まで続き、西側連合国とソ連との共同和解により、公式にはどの政治ブロックにも属さない中立民主国家としてのオーストリアの再統一が認められた（ただし、実際にはソ連とより良い関係を保っていた）。 西側同盟国）。 ドイツにおける非ナチス化計画は、ニュルンベルク裁判でのナチス戦犯の訴追と元ナチスの権力の座からの排除につながったが、この政策は恩赦と元ナチスの西ドイツ社会への再統合に向けて進んだ。`,
          },
          {
            content:
              `ドイツは戦前（1937年）の領土の4分の1を失った。 東側領土のうち、シレジア、ノイマルク、ポメラニアの大部分はポーランドに占領され[315]、東プロイセンはポーランドとソ連に分割され、続いてこれらの州から900万人のドイツ人がドイツに追放された[316]。 ] [317] のほか、チェコスロバキアのズデーテン地方出身の300万人のドイツ人もいる。 1950年代までに、西ドイツ人の5分の1は東部からの難民でした。 ソ連はカーゾン線以東のポーランド諸州も占領し[318]、そこから200万人のポーランド人が追放された[317][319]ルーマニア北東部、フィンランド東部の一部[320][321]、 ]とバルト三国はソ連に併合された[323][324]。 イタリアは君主制、植民地帝国、そしてヨーロッパの領土の一部を失いました。.`
          },
          {
            content:
              `世界平和を維持するため[326]、連合国は国連を設立し[327]、1945年10月24日に正式に発足し[328]、1948年に世界人権宣言をすべての国の共通基準として採択した。 加盟国。 [329] 戦争の勝者である大国、フランス、中国、イギリス、ソ連、アメリカは国連安全保障理事会の常任理事国となった[330]。 1971年に中華民国と中華人民共和国の間で、またソビエト連邦とソ連の解散後の後継国家であるロシア連邦の間で2回議席が入れ替わったものの、5つの常任理事国は現在もその地位を維持している。 西側連合国とソ連の間の同盟関係は、戦争が終わる前から悪化し始めていた。`
          },
          {
            content:`ドイツに加えて、ヨーロッパの残りの地域も西側とソ連の勢力圏に分割された[332]。 ほとんどの東欧および中欧諸国はソ連圏に陥り、ソ連占領当局の全面的または部分的支援を受けて共産主義者主導の政権が樹立された。 その結果、東ドイツ[333]、ポーランド、ハンガリー、ルーマニア、ブルガリア、チェコスロバキア、アルバニア[334]がソ連の衛星国となった。 共産主義ユーゴスラビアは完全な独立政策を実施し、ソ連との緊張を引き起こした[335]。 ギリシャの共産主義者の蜂起は英米の支援で鎮圧され、ギリシャは西側との連携を保った。`
          },
          {
            content:
            `戦後の世界の分断は、アメリカ主導のNATOとソ連主導のワルシャワ条約機構という2つの国際軍事同盟によって正式に形成された[337]。 長期にわたる政治的緊張と両国間の軍事競争である冷戦は、世界中で前例のない軍拡競争と多数の代理戦争を伴うことになる。`
          },
          {
            content:`アジアでは、米国が日本の占領を主導し、西太平洋にある日本の旧島々を統治し、一方ソ連は南樺太と千島列島を併合した[339]。 かつて日本の植民地支配下にあった韓国は、1945 年から 1948 年にかけて北でソ連、南で米国によって分割占領されました。1948 年に 38 度線の両側に別々の共和国が出現し、それぞれが正統な国家であると主張しました。 韓国全土のための政府であり、最終的には朝鮮戦争につながった。`
          },
          {
            content: `中国では国民党軍と共産主義軍が1946年6月に内戦を再開した。共産主義軍が勝利して本土に中華人民共和国を樹立したが、国民党軍は1949年に台湾に撤退した[341]。 中東では、国連のパレスチナ分割計画とイスラエル建国に対するアラブ人の拒否が、アラブ・イスラエル紛争の激化を示した。 ヨーロッパの大国は植民地帝国の一部または全部を保持しようとしたが、戦争中の威信と資源の喪失によりこれは失敗し、脱植民地化につながった。`
          },
          {
            content: `参加国はさまざまな影響を受けましたが、世界経済は戦争によって大きな打撃を受けました。 合衆国は他のどの国よりもはるかに裕福になり、ベビーブームを引き起こし、1950年までに一人当たりの国内総生産は他の大国をはるかに上回り、世界経済を支配した[344]。 連合軍占領当局は1945年から1948年にかけて西ドイツで産業軍縮政策を推進した[345]。 国際貿易の相互依存により、この政策はヨーロッパの経済停滞を招き、ヨーロッパの戦争からの回復が数年間遅れました。`
          },
          {
            content: `1944 年 7 月のブレトンウッズ会議で、連合国は戦後世界の経済枠組みを作成しました。 この協定により、国際通貨基金 (IMF) と国際復興開発銀行 (IBRD) が創設され、後に世界銀行グループの一部となりました。 ブレトンウッズ体制は1973年まで続いた[348]。 回復は1948年半ばの西ドイツの通貨改革で始まり、米国のマーシャル・プラン経済援助（1948年 - 1951年）が直接的および間接的に引き起こしたヨーロッパ経済政策の自由化によって加速された[349][350]。 1948年以降の西ドイツの復興はドイツ経済の奇跡と呼ばれている[351]。 イタリアも好景気に見舞われ[352]、フランス経済も回復した[353]。 対照的に、イギリスは経済的に破綻した状態にあり[354]、他のヨーロッパ諸国よりも多いマーシャル・プラン援助総額の4分の1を受けていたにもかかわらず[355]、数十年にわたって相対的な経済衰退が続いた[356]。 】 ソビエト連邦は、莫大な人的および物的損失にもかかわらず、戦後すぐに生産の急速な増加を経験し[357]、ドイツの工業工場のほとんどを接収および移転し、衛星国から戦争賠償金を徴収した[b][。 [358] 日本はかなり遅れて復興した [359] 中国は 1952 年までに戦前の工業生産に戻りました。`
          }
